        ...
        <div class="container-fluid text-center">    
            <div class="row content">
                ...
                <div class="col-sm-8 text-left"> 
                    ...
                    <div class="container">
                        <a class href="">
                            <button type="text" class="btn btn-default btn-round" id="botonCrear"> Crear Notas</button>
                        </a>
                    </div>
                    <br>
                    <form id="crearNotas" >
                        <div class="form-group">
                            <label style="color:white">Id Estudiante:</label>
                            <input  required class="form-control form-control-success" id="id_estudiante" >
                            <label style="color:white">Nota:</label>
                            <input  required class="form-control form-control-success" id="nota"  >
